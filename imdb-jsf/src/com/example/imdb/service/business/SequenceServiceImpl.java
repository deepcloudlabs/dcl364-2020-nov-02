...
// @nnotation -> Descriptive Programming
// Context and Dependency Injection (CDI) (Java EE 6) -> Spring
@Named // CDI Bean -> Life Cycle (TomEE)
//@ApplicationScoped
//@SessionScoped
//@RequestScoped
//@ConversationScoped
@Singleton // This is default in Spring
// If you skip scope definition => Spring: @Scope("prototype")
